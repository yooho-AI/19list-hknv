...
const CHEN_ZIQIAN: Character = {
  id: 'chenziqian',
  name: '陈子谦',
  portrait: '/characters/chenziqian.jpg',
  gender: 'male',
  age: 30,
  title: '富三代继承人',
...
const ZHANG_YOUNING: Character = {
  id: 'zhangyouning',
  name: '张佑宁',
  portrait: '/characters/zhangyouning.jpg',
  gender: 'male',
  age: 25,
  title: '新生代偶像',
...
const LI_ZHIXUAN: Character = {
  id: 'lizhixuan',
  name: '李志轩',
  portrait: '/characters/lizhixuan.jpg',
  gender: 'male',
  age: 32,
  title: '大学副教授',
...
const CHENG_ZHIFENG: Character = {
  id: 'chengzhifeng',
  name: '程志峰',
  portrait: '/characters/chengzhifeng.jpg',
  gender: 'male',
  age: 35,
  title: '电视台副台长',
...
export const SCENES: Record<string, Scene> = {
  ...
  tvstation: {
    ...
    background: '/scenes/tvstation.jpg',
  ...
  causewaybay: {
    ...
    background: '/scenes/causewaybay.jpg',
  ...
  westkowloon: {
    ...
    background: '/scenes/westkowloon.jpg',
